...
int cmp_func_name_asс(const void *a, const void *b) {
    detail *d1 = (detail *) a;
    detail *d2 = (detail *) b;
...
int cmp_func_id_asс(const void *a, const void *b) {
    detail *d1 = (detail *) a;
    detail *d2 = (detail *) b;
...
int cmp_func_count_asс(const void *a, const void *b) {
    detail *d1 = (detail *) a;
    detail *d2 = (detail *) b;
...
comp_func get_comp_func(int comparison, int sort_desc) {
    switch (comparison) {
        case SORT_NAME:
            if (!sort_desc)
                return cmp_func_name_asс;
            return cmp_func_name_desc;
        case SORT_ID:
            if (!sort_desc)
            return cmp_func_id_asс;
            return cmp_func_id_desc;
        case SORT_COUNT:
            if (!sort_desc)
            return cmp_func_count_asс;
